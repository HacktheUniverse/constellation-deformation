...
- (void)viewDidLoad{
    ...
    titleColor = 0.25;
    [self performSelector:@selector(scene1) withObject:nil afterDelay:3.0];
...
//    [self loadConstellations];
    ...
    NSArray *cArray = [CONSTELLATION_ARRAY_STRING componentsSeparatedByString:@", "];
